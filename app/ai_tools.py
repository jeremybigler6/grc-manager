...
def framework_control_assistant_menu():
    print("\n========== Framework Assistant ==========")
    print("1. ISO 27001")
    print("2. NIST CSF")
    print("3. SOC 2")
    ...
    choice = input("Choose a framework: ").strip()
    ...
    print("\n1. Enter a known control ID")
    print("2. Search current controls")
    ...
    if selection_choice == "1":
        ...
        control_id = displayed[index][0]
    else:
        print("Invalid choice.")
        return

    system_prompt = "You are a cybersecurity GRC analyst. Explain framework controls in plain English with implementation guidance."
    user_prompt = f"Explain this framework control for a beginner. Framework: {framework}; Control ID: {control_id}."
    ai_result = ask_openai(system_prompt, user_prompt)

    result = ai_result.strip() if ai_result else None
    if not result:
        result = (
            f"Fallback explanation for {framework} control {control_id}:\n"
            "- Summarize what the control is intended to achieve.\n"
            "- Describe why it matters for risk reduction and audit evidence.\n"
            "- Note the basic implementation steps and review cadence."
        )
...
def ai_tools_menu(risk=None):
    while True:
        ...
        print("3. Control Builder")
        print("4. Policy Generator")
        print("5. Evidence Review")
        print("6. Report Writer")
        print("7. Back")
        ...
        if choice == "1":
            ...
            framework_control_assistant_menu()

        elif choice == "3":
            control_builder_menu()

        elif choice == "4":
            policy_generator_menu()

        elif choice == "5":
            evidence_review_menu()
